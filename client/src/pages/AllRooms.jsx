...
const RadionButton = ({label,selected=false,onChange = ()=>{}}) =>{
    return(
        <label className='flex gap-3 items-center cursor-pointer mt-2 text-sm' >
    ...
    return(
        ...
        <div className="flex flex-col-reverse  lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32 ">
                ...
                {roomsDummyData.map((room)=>(
                    <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last-pb-30 last:border-0'> 
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            {/* { Room am enties} */}
                            <div className="flex flex-wrap items-center mt-3 mb-6 gap-6">
            ...
            <div className=" bg-white  w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
                ...
                <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} overflow-hidden  transitoin-all duration-700`}> 
                    ...
                    <div className="px-5 pt-5 pb-7">
                        ...
                        {sortOptions.map((option, index)=>(
                            <RadionButton key={index} label={option}/>
                        ))}
                    </div>
                </div>
