...
const Dashboard = () => {
    ...
    return (
        ...
        <div >
            <Title align='left' font='outfit' title='Dashboard' subtitle='Monitor yoour room listings, track bookings and analyze revenue-all in one place.Stay updated with real-time insights to ensure smooth operations.' />
            <div className="flex gap-4 my-8">
                {/* Total Bookings */}
                <div className="bg-blue-50 border-blue-50 rounded flex p-4 pr-8 ">
            ...
            {/* Recent Bookings */}
            <h2 className="text-xl text-blue-950 font-medium mb-5">Recent Booking</h2>
                ...
                <table className="w-full">
                    <thead className="bg-gray">
                        <tr>
                            ...
                            <th className="py-3 px-4 text-gray-800 font-medium text-center">Payment Status Name</th>
                        </tr>
                    </thead>
