...
const Footer = ()=>{
    return(
        ...
        <div className='bg-[#F6F9FC] text-gray-500 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.hotelIcon} alt="logo" className='mb-4 h-10 md:h-9 invert' />
                    <p className='text-sm'>
                        Discover the world's most extraordinary places to stay, from boutique hotels to luxury villas and private islands
                    </p>
                    <div className='flex items-center gap-3 mt-4'>
                        
                        <img src={assets.instagramIcon} alt='insta-icon'/>                        
                        
                        <img src={assets.facebookIcon} alt='facebook-icon'/>                        
                        
                        <img src={assets.twitterIcon} alt='tweeter-icon'/>                        
