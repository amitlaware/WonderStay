    ...
    return(
        <div className="flex flex-col items-center  px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30">
            <div className=" flex flex-col md:flex-row items-center justify-between w-full">
                <Title title='Exclusive Offers' subtitle='Take advantage of oue limited-time offers and special packages to enhance your stay and create unforgettable memories. ' align='left' />
            <button className="group flex items-center gap-2 cursor-pointer font-medium max-md:mt-12">View All Offers 
                <img src={assets.arrowIcon} alt="arrow-icon" className="group-hover:translate-x-1 transitoin-all"/>
            </button>
            </div>
